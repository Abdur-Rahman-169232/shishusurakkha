      ...
      <div>
        ...
        <Card className="mt-8 flex flex-col items-center p-10 text-center">
          ...
          <Button asChild className="mt-6">
            <Link to="/scan">Scan EPI Card</Link>
          </Button>
        </Card>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <Card className="p-5">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link to="/dhis2" className="text-sm font-semibold text-primary">
            View DHIS2 →
          </Link>
        </div>
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <Link to="/scan" className="rounded-2xl bg-primary p-5 text-primary-foreground">
        ...
        <Link to="/voice" className="rounded-2xl bg-violet-700 p-5 text-white">
        ...
        <Link to="/dhis2" className="rounded-2xl border border-primary/20 bg-accent p-5 text-accent-foreground">
      ...
      <Card className="p-5">
        ...
        <div className="space-y-3">
          {children.slice(0, 5).map((child) => {
            ...
            return (
              <Link key={child.shishu_id} to={`/children/${child.id || child.shishu_id}`} className="flex min-h-[48px] items-center gap-3 rounded-xl border border-border p-3">
